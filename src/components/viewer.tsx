...
export default function Viewer() {
    ...
    return (
        ...
        >
            <div
                className={`rounded-2xl border-[1px] border-gray-300 dark:border-gray-600 shadow-lg shadow-gray-400/10 dark:shadow-gray-900/50 overflow-auto m-6 flex flex-col w-full max-w-[70rem]   ${isVisible ? "scale-100 opacity-100" : "scale-0 opacity-0"} transition-all`}
            >
